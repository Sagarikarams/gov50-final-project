...
```
The coefficient of emp_rate is -0.663, which means there is a decrease in the Difference between CPI growth and ECI growth(outcome) by 0.663 points with a one-unit increase in employment rate, when other variables don’t change.

The coefficient of gov_cur_expend is -0.002, which means there is a decrease in the Difference between CPI growth and ECI growth(outcome) by 0.002 points with a one-unit increase in Government Current Expenditures, when other variables don’t change.

The coefficient of pce is 0.002, which means there is an increase in the Difference between CPI growth and ECI growth(outcome) by 0.002 points with a one-unit increase in Personal Consumption Expenditures, when other variables don’t change.

The coefficient of corp_profit is 0.002, which means there is an increase in the Difference between CPI growth and ECI growth(outcome) by 0.002 points with a one-unit increase in Corporate Profits, when other variables don’t change.
