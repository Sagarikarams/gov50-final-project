...
```
```{r}
ggplot(totalwage_weekly, aes(x = Date, y = Index)) + geom_line() + labs(title = "Median weekly earnings over 10 years for ages 16 and above")
```
...
```
```{r}
ggplot(menwage_weekly, aes(x = Date, y = Index)) + geom_line()+ labs(title = "Median weekly earnings over 10 years for men of ages 16 and above")
```
...
```{r}
ggplot(womenwage_weekly, aes(x = Date, y = Index)) + geom_line() + labs(title = "Median weekly earnings over 10 years for women of ages 16 and above")
```
